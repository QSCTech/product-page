...
export default function PhoneNavbar(): JSX.Element {
    ...
    let displayDetail: boolean = false;
        ...
        <>
            <header className={styles.navbar}>
                <div className={styles.qscicon}>
                    <Image src={qscIcon} widsth={155} height={58} />
                </div>
                <div className={styles.menuicon} onClick={() => { changeDisplay() }} id="menuIcon" >
                    <Image src={menuIcon} width={24} height={24} />
                </div>
                <div className={styles.menuicon} onClick={() => { changeDisplay() }} id="closeIcon" >
                                ...
                                <li key={index.toString()} className={styles.item}>
                                    ...
                                    <div className={styles.linklist}>
                                        {value.list.map((value, index) => {
                                            return (
                                                <div className={styles.linklistitem} key={index.toString()}>
